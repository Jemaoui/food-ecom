 ...
 */
final class Version20241130114726 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, created_at DATETIME NOT NULL, status VARCHAR(255) NOT NULL, total_amount DOUBLE PRECISION NOT NULL, payment_method VARCHAR(255) DEFAULT NULL, shipping_address VARCHAR(255) DEFAULT NULL, INDEX IDX_F52993989395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
